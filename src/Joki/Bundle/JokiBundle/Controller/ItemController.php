...
use Joki\Bundle\JokiBundle\Entity\Item;
use Joki\Bundle\JokiBundle\Form\ItemType;
...
class ItemController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('JokiJokiBundle:Item')->findAll();
     ...
     * @Method("POST")
     * @Template("JokiJokiBundle:Item:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('JokiJokiBundle:Item')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("JokiJokiBundle:Item:edit.html.twig")
     */
