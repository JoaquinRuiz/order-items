...
use Joki\Bundle\JokiBundle\Entity\Country;
use Joki\Bundle\JokiBundle\Form\CountryType;
...
class CountryController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('JokiJokiBundle:Country')->findAll();
     ...
     * @Method("POST")
     * @Template("JokiJokiBundle:Country:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('JokiJokiBundle:Country')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("JokiJokiBundle:Country:edit.html.twig")
     */
